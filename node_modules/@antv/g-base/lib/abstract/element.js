...
var mat3 = require("@antv/matrix-util/lib/mat3");
...
var Element = /** @class */ (function (_super) {
    ...
    Element.prototype.translate = function (translateX, translateY) {
        ...
        var newMatrix = mat3.transform(matrix, [['t', translateX, translateY]]);
    ...
    Element.prototype.scale = function (ratioX, ratioY) {
        var matrix = this.getMatrix();
        var newMatrix = mat3.transform(matrix, [['s', ratioX, ratioY || ratioX]]);
        this.setMatrix(newMatrix);
        return this;
    };
    /**
    ...
    Element.prototype.rotate = function (radian) {
        var matrix = this.getMatrix();
        var newMatrix = mat3.transform(matrix, [['r', radian]]);
        this.setMatrix(newMatrix);
        return this;
    };
    /**
    ...
    Element.prototype.rotateAtStart = function (rotate) {
        ...
        var matrix = this.getMatrix();
        var newMatrix = mat3.transform(matrix, [
            ['t', -x, -y],
            ['r', rotate],
            ['t', x, y],
        ]);
