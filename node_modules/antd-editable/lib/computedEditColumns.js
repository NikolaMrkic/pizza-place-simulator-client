...
var _default = function _default(columns, curCell, setCurCell, form) {
  var dataIndexMap = [];
      ...
      if (item.children) {
        ...
        var resItem = _extends({
          ...
          render: function render(text, record, rowIndex) {
            ...
            var initialValue = (0, _utils.hasData)(_render ? _render(text, record, rowIndex) : text);
            ...
            if (editable && canRowEditbale) {
              ...
              return React.createElement(_Cell["default"], cellprops);
            }
